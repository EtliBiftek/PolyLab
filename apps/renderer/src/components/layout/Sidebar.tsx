  ...
  return (
    <aside className="flex w-[264px] shrink-0 flex-col border-r border-border bg-bg-1 transition-all duration-200">
      ...
      <div className="px-3 pt-2">
        <Button variant="subtle" size="sm" className="w-full justify-start" onClick={() => void newConversation(lastModelId)}><PlusIcon className="h-4 w-4" />{t("sidebar.newChat")}</Button>
